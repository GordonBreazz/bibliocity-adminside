<template>
  <v-container>
    <v-row class="text-center">
      <v-col cols="12">
        <v-img
          :src="require('../assets/logo/bibliocity.png')"
          class="my-3"
          contain
          height="180"
        />
      ...
      <v-col >
        ...
        <p class="subheading font-weight-regular mb-0">
          Это раздел для администраторов ресурса.
          Пожалуйста войдите, либо зарегистрируйтесь
        </p>
      </v-col>
    </v-row>
    <v-row>
